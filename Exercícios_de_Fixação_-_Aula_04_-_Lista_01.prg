...
Function Exercicio17()
    ...
    QOUT("--as variaveis deveriam ser Real e nao Inteiro")
    QOUT("--fez a leitura de apenas uma nota, eram duas entradas")
...
Function Exercicio18()
    ...
    QOUT("")
    QOUT("O programa demonstra que a ordem dos fatores nao altera o resultado da multiplicacao")
    QOUT("")
    QOUT("***************")
    QOUT("")
Return nil
